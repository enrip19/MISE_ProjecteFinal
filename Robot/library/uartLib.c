...
void send_UART(str_control *dataPointer){
    ...
    delay(delayUART);                                             //quan acabem esperem 100 ms ja que es el que ens demanen els motors (o emulador) entre trames (hem forc,at la maquina per ferlo funcionar mes rapid)
}
